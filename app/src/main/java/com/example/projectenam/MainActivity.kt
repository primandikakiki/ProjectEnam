...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rv_parts.adapter = ContactAdapter(textData, { phoneItem : PhoneData -> phoneItemClicked(phoneItem) })
    }
    ...
    private fun createPhoneData(): List<PhoneData> {
        ...
        partList.add(PhoneData(6282337477449,"Tika"))
        partList.add(PhoneData(62822300013246,"Cready"))
        return partList
    }
}
